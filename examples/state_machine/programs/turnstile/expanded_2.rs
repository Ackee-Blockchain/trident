...
#[doc = r""]
#[doc = r" These methods fall into one of three categories, each of which"]
#[doc = r#" can be considered a different "namespace" of the program."#]
#[doc = r""]
#[doc = r" 1) Global methods - regular methods inside of the `#[program]`."]
#[doc = r" 2) State methods - associated methods inside a `#[state]` struct."]
#[doc = r" 3) Interface methods - methods inside a strait struct's"]
#[doc = r"    implementation of an `#[interface]` trait."]
#[doc = r""]
...
pub mod program {
    ...
    impl ::core::clone::Clone for Turnstile {
        ...
        fn clone(&self) -> Turnstile {
            match *self { Turnstile => Turnstile, }
        }
    }
    impl anchor_lang::AccountDeserialize for Turnstile {
        ...
        fn try_deserialize_unchecked(_buf: &mut &[u8])
         ->
             std::result::Result<Self,
                                 anchor_lang::solana_program::program_error::ProgramError> {
            Ok(Turnstile)
...
#[doc = r""]
#[doc =
  r#" where the namespace can be one of three types. 1) "global" for a"#]
#[doc = r#" regular instruction, 2) "state" for a state struct instruction"#]
#[doc = r" handler and 3) a trait namespace (used in combination with the"]
#[doc =
  r" `#[interface]` attribute), which is defined by the trait name, e.."]
#[doc = r" `MyTrait`."]
#[doc = r""]
 ...
 -> ProgramResult {
    ...
    if true {
        if sighash == anchor_lang::idl::IDL_IX_TAG.to_le_bytes() {
            return __private::__idl::__idl_dispatch(program_id, accounts,
                                                    &ix_data);
        }
    }
    match sighash {
...
mod __private {
    ...
    pub mod __idl {
        ...
        pub fn __idl_dispatch(program_id: &Pubkey, accounts: &[AccountInfo],
            ...
            match ix {
                anchor_lang::idl::IdlInstruction::Create { data_len } => {
                    let mut accounts =
                        anchor_lang::idl::IdlCreateAccounts::try_accounts(program_id,
                                                                          &mut accounts,
                                                                          &[])?;
                    __idl_create_account(program_id, &mut accounts,
                                         data_len)?;
                    accounts.exit(program_id)?;
                }
                anchor_lang::idl::IdlInstruction::CreateBuffer => {
                    let mut accounts =
                        anchor_lang::idl::IdlCreateBuffer::try_accounts(program_id,
                                                                        &mut accounts,
                                                                        &[])?;
                ...
                anchor_lang::idl::IdlInstruction::Write { data } => {
                    let mut accounts =
                        anchor_lang::idl::IdlAccounts::try_accounts(program_id,
                                                                    &mut accounts,
                                                                    &[])?;
                ...
                anchor_lang::idl::IdlInstruction::SetBuffer => {
                    let mut accounts =
                        anchor_lang::idl::IdlSetBuffer::try_accounts(program_id,
                                                                     &mut accounts,
                                                                     &[])?;
        ...
        pub fn __idl_create_account(program_id: &Pubkey,
                                    accounts:
                                        &mut anchor_lang::idl::IdlCreateAccounts,
                                    data_len: u64) -> ProgramResult {
        ...
        pub fn __idl_create_buffer(program_id: &Pubkey,
                                   accounts:
                                       &mut anchor_lang::idl::IdlCreateBuffer)
         -> ProgramResult {
        ...
        #[inline(never)]
        pub fn __idl_write(program_id: &Pubkey,
                           accounts: &mut anchor_lang::idl::IdlAccounts,
                           idl_data: Vec<u8>) -> ProgramResult {
        ...
        pub fn __idl_set_authority(program_id: &Pubkey,
                                   accounts:
                                       &mut anchor_lang::idl::IdlAccounts,
                                   new_authority: Pubkey) -> ProgramResult {
    ...
    #[doc = r" __state mod defines wrapped handlers for state instructions."]
    pub mod __state {
        use super::*;
    }
    #[doc =
      r" __interface mod defines wrapped handlers for `#[interface]` trait"]
    ...
    pub mod __global {
        ...
        #[inline(never)]
        pub fn push(program_id: &Pubkey, accounts: &[AccountInfo],
                    ix_data: &[u8]) -> ProgramResult {
            let ix =
                instruction::Push::deserialize(&mut &ix_data[..]).map_err(|_|
                                                                              anchor_lang::__private::ErrorCode::InstructionDidNotDeserialize)?;
            ...
            let mut accounts =
                UpdateState::try_accounts(program_id, &mut remaining_accounts,
                                          ix_data)?;
            turnstile::push(Context::new(program_id, &mut accounts,
                                         remaining_accounts))?;
            accounts.exit(program_id)
        }
    }
...
pub mod turnstile {
    ...
    pub fn push(ctx: Context<UpdateState>) -> ProgramResult {
        ...
        if state.locked {
            state.res = false;
        } else { state.locked = true; state.res = true; }
        Ok(())
    }
}
...
pub mod instruction {
    use super::*;
    #[doc = r" Instruction struct definitions for `#[state]` methods."]
    pub mod state {
        use super::*;
    }
    #[doc = r" Instruction."]
...
pub mod fat_instruction {
    ...
    impl trdelnik_program::FatInstruction for Initialize {
        ...
        fn new(instruction: Self::INSTRUCTION, accounts: Self::ACCOUNTS)
         -> Self {
        ...
        fn into_instruction_and_accounts(self)
    ...
    pub struct Push {
        instruction: super::instruction::Push,
        accounts: super::accounts::UpdateState,
    }
    impl trdelnik_program::FatInstruction for Push {
        type INSTRUCTION = super::instruction::Push;
        type ACCOUNTS = super::accounts::UpdateState;
        fn new(instruction: Self::INSTRUCTION, accounts: Self::ACCOUNTS)
         -> Self {
            Self{instruction, accounts,}
...
#[automatically_derived]
impl<'info> anchor_lang::Accounts<'info> for Initialize<'info> where
 'info: 'info {
    #[inline(never)]
    fn try_accounts(program_id: &anchor_lang::solana_program::pubkey::Pubkey,
                    accounts:
     ...
     ->
        ...
        *accounts = &accounts[1..];
        let user: AccountInfo =
            anchor_lang::Accounts::try_accounts(program_id, accounts,
                                                ix_data)?;
        ...
        let state =
            {
                if !false ||
                    ...
                    let __current_lamports =
                        state.to_account_info().lamports();
                    if __current_lamports == 0 {
                        let lamports = __anchor_rent.minimum_balance(space);
                        anchor_lang::solana_program::program::invoke_signed(&anchor_lang::solana_program::system_instruction::create_account(payer.to_account_info().key,
                        ...
                        if required_lamports > 0 {
                            anchor_lang::solana_program::program::invoke(&anchor_lang::solana_program::system_instruction::transfer(payer.to_account_info().key,
                                                                                                                                    state.to_account_info().key,
                                                                                                                                    required_lamports),
                                                                         &[payer.to_account_info(),
                                                                           state.to_account_info(),
                        ...
                        anchor_lang::solana_program::program::invoke_signed(&anchor_lang::solana_program::system_instruction::allocate(state.to_account_info().key,
                                                                                                                                       space
                                                                                                                                           as
                                                                                                                                           u64),
                                                                            &[state.to_account_info(),
                                                                              system_program.to_account_info()],
                                                                            &[])?;
                        anchor_lang::solana_program::program::invoke_signed(&anchor_lang::solana_program::system_instruction::assign(state.to_account_info().key,
                                                                                                                                     program_id),
                                                                            &[state.to_account_info(),
                                                                              system_program.to_account_info()],
                                                                            &[])?;
                ...
                let pa: anchor_lang::Account<State> =
        ...
        if !__anchor_rent.is_exempt(state.to_account_info().lamports(),
        ...
        Ok(Initialize{state, user, system_program,})
    }
}
#[automatically_derived]
impl<'info> anchor_lang::ToAccountInfos<'info> for Initialize<'info> where
 'info: 'info {
...
#[automatically_derived]
impl<'info> anchor_lang::AccountsExit<'info> for Initialize<'info> where
 'info: 'info {
...
pub(crate) mod __client_accounts_initialize {
    ...
    impl borsh::ser::BorshSerialize for Initialize where
    ...
    impl anchor_lang::ToAccountMetas for Initialize {
        fn to_account_metas(&self, is_signer: Option<bool>)
         -> Vec<anchor_lang::solana_program::instruction::AccountMeta> {
            let mut account_metas = ::alloc::vec::Vec::new();
            account_metas.push(anchor_lang::solana_program::instruction::AccountMeta::new(self.state,
                                                                                          true));
            account_metas.push(anchor_lang::solana_program::instruction::AccountMeta::new_readonly(self.user,
                                                                                                   true));
...
pub(crate) mod __cpi_client_accounts_initialize {
    ...
    impl<'info> anchor_lang::ToAccountMetas for Initialize<'info> {
        fn to_account_metas(&self, is_signer: Option<bool>)
         -> Vec<anchor_lang::solana_program::instruction::AccountMeta> {
            let mut account_metas = ::alloc::vec::Vec::new();
            account_metas.push(anchor_lang::solana_program::instruction::AccountMeta::new(anchor_lang::Key::key(&self.state),
                                                                                          true));
            account_metas.push(anchor_lang::solana_program::instruction::AccountMeta::new_readonly(anchor_lang::Key::key(&self.user),
                                                                                                   true));
    ...
    impl<'info> anchor_lang::ToAccountInfos<'info> for Initialize<'info> {
        fn to_account_infos(&self)
         ->
            ...
            account_infos.push(anchor_lang::ToAccountInfo::to_account_info(&self.system_program));
            account_infos
        }
    }
}
...
#[automatically_derived]
impl<'info> anchor_lang::Accounts<'info> for UpdateState<'info> where
 'info: 'info {
    #[inline(never)]
    fn try_accounts(program_id: &anchor_lang::solana_program::pubkey::Pubkey,
                    accounts:
...
#[automatically_derived]
impl<'info> anchor_lang::ToAccountInfos<'info> for UpdateState<'info> where
 'info: 'info {
    fn to_account_infos(&self)
     -> Vec<anchor_lang::solana_program::account_info::AccountInfo<'info>> {
        let mut account_infos = ::alloc::vec::Vec::new();
...
#[automatically_derived]
impl<'info> anchor_lang::AccountsExit<'info> for UpdateState<'info> where
 'info: 'info {
    fn exit(&self, program_id: &anchor_lang::solana_program::pubkey::Pubkey)
     -> anchor_lang::solana_program::entrypoint::ProgramResult {
        anchor_lang::AccountsExit::exit(&self.state, program_id)?;
...
pub(crate) mod __client_accounts_update_state {
    ...
    impl borsh::ser::BorshSerialize for UpdateState where
     anchor_lang::solana_program::pubkey::Pubkey: borsh::ser::BorshSerialize {
        fn serialize<W: borsh::maybestd::io::Write>(&self, writer: &mut W)
         -> ::core::result::Result<(), borsh::maybestd::io::Error> {
            borsh::BorshSerialize::serialize(&self.state, writer)?;
...
impl borsh::ser::BorshSerialize for State where
 bool: borsh::ser::BorshSerialize, bool: borsh::ser::BorshSerialize {
    fn serialize<W: borsh::maybestd::io::Write>(&self, writer: &mut W)
     -> ::core::result::Result<(), borsh::maybestd::io::Error> {
...
impl borsh::de::BorshDeserialize for State where
 bool: borsh::BorshDeserialize, bool: borsh::BorshDeserialize {
    fn deserialize(buf: &mut &[u8])
     -> ::core::result::Result<Self, borsh::maybestd::io::Error> {
        Ok(Self{locked: borsh::BorshDeserialize::deserialize(buf)?,
...
impl ::core::clone::Clone for State {
    ...
    fn clone(&self) -> State {
        match *self {
            State { locked: ref __self_0_0, res: ref __self_0_1 } =>
            State{locked: ::core::clone::Clone::clone(&(*__self_0_0)),
...
impl anchor_lang::AccountSerialize for State {
    fn try_serialize<W: std::io::Write>(&self, writer: &mut W)
     -> std::result::Result<(), ProgramError> {
        writer.write_all(&[216, 146, 107, 94, 104, 75, 182,
                           177]).map_err(|_|
                                             anchor_lang::__private::ErrorCode::AccountDidNotSerialize)?;
        AnchorSerialize::serialize(self,
                                   writer).map_err(|_|
                                                       anchor_lang::__private::ErrorCode::AccountDidNotSerialize)?;
        Ok(())
    }
    ...
    fn try_deserialize_unchecked(buf: &mut &[u8])
     -> std::result::Result<Self, ProgramError> {
        ...
        AnchorDeserialize::deserialize(&mut data).map_err(|_|
                                                              anchor_lang::__private::ErrorCode::AccountDidNotDeserialize.into())
    }
}
#[automatically_derived]
impl anchor_lang::Discriminator for State {
    fn discriminator() -> [u8; 8] { [216, 146, 107, 94, 104, 75, 182, 177] }
}
#[automatically_derived]
