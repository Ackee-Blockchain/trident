...
#[doc = r""]
#[doc = r#" where the namespace can be one of three types. 1) "global" for a"#]
...
#[doc = r" `#[interface]` attribute), which is defined by the trait name, e.."]
#[doc = r" `MyTrait`."]
#[doc = r""]
...
mod __private {
    ...
    #[doc = r" __interface mod defines wrapped handlers for `#[interface]` trait"]
    ...
    pub mod __global {
        ...
        pub fn coin(
            ...
            turnstile::coin(Context::new(program_id, &mut accounts, remaining_accounts))?;
            accounts.exit(program_id)
        }
        #[inline(never)]
        pub fn push(
