pub mod fuzz_example5_fuzz_instructions {
    ...
    impl<'info> IxOps<'info> for InitVesting {
        type IxData = fuzz_example5::instruction::InitVesting;
        ...
        fn get_data(
            ...
            let data = fuzz_example5::instruction::InitVesting {
        ...
        fn get_accounts(
            ...
            let acc_meta = fuzz_example5::accounts::InitVesting {
    ...
    impl<'info> IxOps<'info> for WithdrawUnlocked {
        type IxData = fuzz_example5::instruction::WithdrawUnlocked;
        type IxAccounts = FuzzAccounts;
        ...
        fn get_data(
            ...
            let data = fuzz_example5::instruction::WithdrawUnlocked {};
            Ok(data)
        }
        fn get_accounts(
            &self,
            ...
            let acc_meta = fuzz_example5::accounts::WithdrawUnlocked {
                recipient: recipient.pubkey(),
                recipient_token_account,
                escrow: escrow.pubkey(),
                escrow_token_account,
