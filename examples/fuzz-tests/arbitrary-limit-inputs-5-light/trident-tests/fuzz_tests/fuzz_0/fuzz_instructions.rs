pub mod arbitrary_limit_inputs_5_light_fuzz_instructions {
    use arbitrary_limit_inputs_5_light::trident_fuzz_InitVesting_snapshot::InitVestingSnapshot;
    use arbitrary_limit_inputs_5_light::trident_fuzz_WithdrawUnlocked_snapshot::WithdrawUnlockedSnapshot;
    ...
    impl<'info> IxOps<'info> for InitVesting {
        type IxData = arbitrary_limit_inputs_5_light::instruction::InitVesting;
        ...
        fn get_data(
            ...
            let data = arbitrary_limit_inputs_5_light::instruction::InitVesting {
        ...
        fn get_accounts(
            ...
            let escrow = fuzz_accounts
                ...
                .get_or_create_account(
                    ...
                    &arbitrary_limit_inputs_5_light::ID,
                )
                .unwrap();
            ...
            let acc_meta = arbitrary_limit_inputs_5_light::accounts::InitVesting {
    ...
    impl<'info> IxOps<'info> for WithdrawUnlocked {
        type IxData = arbitrary_limit_inputs_5_light::instruction::WithdrawUnlocked;
        type IxAccounts = FuzzAccounts;
        ...
        fn get_data(
            ...
            let data = arbitrary_limit_inputs_5_light::instruction::WithdrawUnlocked {};
            Ok(data)
        }
        fn get_accounts(
            &self,
            ...
            let acc_meta = arbitrary_limit_inputs_5_light::accounts::WithdrawUnlocked {
                recipient: recipient.pubkey(),
                recipient_token_account,
                escrow: escrow.pubkey(),
                escrow_token_account,
