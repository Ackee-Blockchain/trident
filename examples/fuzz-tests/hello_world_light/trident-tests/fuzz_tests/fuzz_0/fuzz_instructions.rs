pub mod hello_world_light_fuzz_instructions {
    use hello_world_light::trident_fuzz_Initialize_snapshot::InitializeSnapshot;
    ...
    impl<'info> IxOps<'info> for Initialize {
        type IxData = hello_world_light::instruction::Initialize;
        ...
        fn get_data(
            ...
            let data = hello_world_light::instruction::Initialize {
        ...
        fn get_accounts(
            ...
            let hello_world_account = fuzz_accounts
                ...
                .get_or_create_account(
                    ...
                    &[b"hello_world_seed"],
                    &hello_world_light::ID,
                )
                .unwrap();
            let signers = vec![author.clone()];
            let acc_meta = hello_world_light::accounts::Initialize {
