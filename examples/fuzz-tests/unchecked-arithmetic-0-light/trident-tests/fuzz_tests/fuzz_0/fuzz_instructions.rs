pub mod unchecked_arithmetic_0_light_fuzz_instructions {
    use solana_sdk::native_token::LAMPORTS_PER_SOL;
    use solana_sdk::system_program::ID as SYSTEM_PROGRAM_ID;
    use trident_client::fuzzing::*;
    use unchecked_arithmetic_0_light::trident_fuzz_Initialize_snapshot::InitializeSnapshot;
    use unchecked_arithmetic_0_light::trident_fuzz_Update_snapshot::UpdateSnapshot;
    ...
    impl<'info> IxOps<'info> for Initialize {
        type IxData = unchecked_arithmetic_0_light::instruction::Initialize;
        ...
        fn get_data(
            ...
            let data = unchecked_arithmetic_0_light::instruction::Initialize {};
            Ok(data)
        }
        fn get_accounts(
            &self,
            ...
            let acc_meta = unchecked_arithmetic_0_light::accounts::Initialize {
    ...
    impl<'info> IxOps<'info> for Update {
        type IxData = unchecked_arithmetic_0_light::instruction::Update;
        type IxAccounts = FuzzAccounts;
        ...
        fn get_data(
            ...
            let data = unchecked_arithmetic_0_light::instruction::Update {
        ...
        fn get_accounts(
            ...
            let acc_meta = unchecked_arithmetic_0_light::accounts::Update {
                counter: counter.pubkey(),
