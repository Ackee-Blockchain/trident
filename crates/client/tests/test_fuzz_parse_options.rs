#[cfg(test)]
mod tests {
    pub use trdelnik_client::__private::get_cmd_option_value;
    pub use trdelnik_client::__private::get_crash_dir_and_ext;
    pub use trdelnik_client::constants::HFUZZ_WORKSPACE_DEFAULT;
