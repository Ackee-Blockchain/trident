...
pub fn anchor_keypair(
    program_name: &str,
) -> Result<solana_sdk::signature::Keypair, Box<dyn Error>> {
    ...
    solana_sdk::signature::Keypair::read_from_file(keypair_path)
}

/// Generate a random keypair.
pub fn random_keypair() -> solana_sdk::signature::Keypair {
...
pub fn program_keypair(n: usize) -> solana_sdk::signature::Keypair {
    solana_sdk::signature::Keypair::from_bytes(&PROGRAM_KEYPAIRS[n]).unwrap()
}
...
/// The `n` must be a number between `0` and `29`.
pub fn system_keypair(n: usize) -> solana_sdk::signature::Keypair {
    solana_sdk::signature::Keypair::from_bytes(&SYSTEM_KEYPAIRS[n]).unwrap()
}
...
pub fn keypair(n: usize) -> solana_sdk::signature::Keypair {
    solana_sdk::signature::Keypair::from_bytes(&KEYPAIRS[n]).unwrap()
}
