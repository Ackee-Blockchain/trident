...
pub(crate) fn idl_type_to_syn_type(idl_type: &IdlType, nestings: u8) -> (syn::Type, bool) {
    if nestings >= 5 {
    ...
    match idl_type {
        ...
        IdlType::PublicKey => (parse_quote!(AccountId), false), // Replace with AccountId if needed
